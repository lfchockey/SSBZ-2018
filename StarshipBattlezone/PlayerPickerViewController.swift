...
struct Game {
    ...
    static var students = ["Mr Black", "Allan", "Apsey", "Babcock", "Birley", "Bland", "Bogora", "Brady", "Chen", "Cooke", "Dickson", "Dopson", "Ferguson", "Foster", "Galazzo", "Garvin", "Johnston", "Kelford", "Leung", "Mai", "Nichols", "Rakus", "Smith", "Snyder", "Student", "Thibault", "Thompson", "Tolentino", "Tripp", "Yanosik"]
